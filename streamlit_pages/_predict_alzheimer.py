...
def prediction_page():
    ...
    st.write("""
        ...
        <h1 class="title-text">Patient Information</h1>
    ...
    st.write("""
        ...
        <h2 class="header-text">Demographics</h2>
        """, unsafe_allow_html=True)
    ...
    st.write("""
        ...
        <h2 class="header-text">Genetic Information</h2>
        """, unsafe_allow_html=True)
    ...
    st.write("""
        ...
        <h2 class="header-text">Cognitive Assessment</h2>
        """, unsafe_allow_html=True)
