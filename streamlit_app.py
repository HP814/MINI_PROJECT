...
from streamlit_pages._detection_alzheimer import detection_page
...
app_mode = st.sidebar.selectbox(
    ...
    ["Home", "Predict Alzheimer's","Detect Alzheimer's", "Team Members"],
)
...
# Contact
For inquiries, you can mail us [here](mailto:harshalispatil814@gmail.com).
""")
...
def main():
    ...
    if app_mode == "Predict Alzheimer's":
        prediction_page()
    if app_mode == "Detect Alzheimer's":
        detection_page()
